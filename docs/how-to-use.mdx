...
_The embedded YouTube video player that plays a song._

## Play Button

_Button used to play and pause a song._
...
Press it once to slow down a song.
Press it again to go back to normal speed.

## Loop Button

_Button used to loop a part of a song._

Here's how you can loop a part of a song that you're playing:
...
_Buttons used to skip backward and forward in a song._
