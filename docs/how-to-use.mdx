...
When you tap on the Video URL Bar, you see your video history.
You can select a video to load it without having to paste the URL again.

### Special commands

You can use these special commands by entering them in the Video URL Bar:

`CLEAR_HISTORY` - Clear your video history.

`CLEAR_COOKIES` - Clear all local storage.
